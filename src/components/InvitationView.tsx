...
export default function InvitationView({ config }: { config: InvitationConfig }) {
  ...
  if (isSimple) {
    return (
      <div className="min-h-screen bg-white text-gray-900 flex flex-col items-center p-8 md:p-20 relative">
  ...
  return (
    <div ref={containerRef} className="relative bg-[#05050a] text-white overflow-x-hidden min-h-screen">
